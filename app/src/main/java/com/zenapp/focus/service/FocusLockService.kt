package com.zenapp.focus.service
...
import com.zenapp.focus.MainActivity
...
import com.zenapp.focus.domain.usecase.session.CompleteSessionUseCase
import com.zenapp.focus.domain.usecase.session.UpdateSessionPhaseUseCase
    ...
    private fun showLockOverlay(session: FocusSession) {
        ...
        val composeView = ComposeView(this).apply {
            ...
            setContent {
                ...
                com.zenapp.focus.presentation.theme.ZenAppTheme {
                    com.zenapp.focus.presentation.focus.lock.LockScreenContent(
                        session = session,
