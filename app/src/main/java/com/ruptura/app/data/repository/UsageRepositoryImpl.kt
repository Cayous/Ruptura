...
import com.ruptura.app.data.cache.CacheTTL
import com.ruptura.app.data.cache.UsageDataCacheEntry
import com.ruptura.app.data.mapper.UsageStatsMapper
...
class UsageRepositoryImpl @Inject constructor(
    ...
    override suspend fun getAppDetailData(packageName: String, timeRange: TimeRange): com.ruptura.app.domain.model.AppDetailData? =
        withContext(Dispatchers.IO) {
